...
public class CommandLineConstants {
  ...
  public static final String MANAGEMENT_ROOT_URL_ARG = "management-url";
  public static final String MANAGEMENT_USERNAME_ARG = "mgnt-username";
  public static final String MANAGEMENT_PASSWORD_ARG = "mgnt-password";
